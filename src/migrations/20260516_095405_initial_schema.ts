...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_badges" AS ENUM('fast-shipping', 'timed-offer', 'bestseller', 'new');
  ...
  CREATE TYPE "public"."enum_pages_type" AS ENUM('page', 'blog', 'landing');
  ...
  CREATE TABLE "products" (
  	...
  	"shipping_days" numeric DEFAULT 3,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_address_country" varchar DEFAULT 'IT',
  ...
  CREATE TABLE "pages" (
  	...
  	"type" "enum_pages_type" DEFAULT 'page',
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Marketplace dei Crediti',
  	"logo_id" integer,
  	"tagline" varchar,
